...
public class CarsFrame extends JFrame implements ActionListener
{
    ...
    private JFormattedTextField mpgField;
    private JFormattedTextField cylindersField;
    private JFormattedTextField displacementField;
    private JFormattedTextField horsepowerField;
    ...
    CarsFrame()
    {
        ...
        JLabel outputLabel = new JLabel("Auto Info:");
        JLabel mpgLabel = new JLabel("MPG:");
        JLabel cylindersLabel = new JLabel("Cylinders:");
        JLabel displacementLabel = new JLabel("Displacement:");
        ...
        mpgField = new JFormattedTextField();
        mpgField.setColumns(15);
        mpgField.setEditable(true);

        cylindersField = new JFormattedTextField();
        cylindersField.setColumns(15);
        cylindersField.setEditable(true);

        displacementField = new JFormattedTextField();
        displacementField.setColumns(15);
        displacementField.setEditable(true);

        horsepowerField = new JFormattedTextField();
        horsepowerField.setColumns(15);
        ...
        accelerationField = new JFormattedTextField();
        ...
        layoutConst.anchor = GridBagConstraints.FIRST_LINE_END;
        layoutConst.gridx = 0;
        layoutConst.gridy = 0;
        ...
        layoutConst.gridx = 2;
        layoutConst.gridy = 0;
        add(cylindersLabel, layoutConst);
        ...
        layoutConst.gridx = 3;
        layoutConst.gridy = 0;
        add(cylindersField, layoutConst);
        ...
        layoutConst.gridx = 0;
        layoutConst.gridy = 1;
        add(displacementLabel, layoutConst);
        ...
        layoutConst.gridx = 1;
        layoutConst.gridy = 1;
        add(displacementField, layoutConst);
        ...
        layoutConst.gridx = 2;
        layoutConst.gridy = 2;
        add(accelerationLabel, layoutConst);
        ...
        layoutConst.gridx = 3;
        layoutConst.gridy = 2;
        add(accelerationField, layoutConst);
    ...
    {
        String mpg, cylinders, displacement, horsepower,  weight, acceleration, year, origin, name;

        mpg = mpgField.getText();
        cylinders = cylindersField.getText();
        displacement = displacementField.getText();
        horsepower = horsepowerField.getText();
        weight = weightField.getText();
        acceleration = accelerationField.getText();
        ...
        try
        {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/javaclass", "testuser", "Pa$$word");

            Statement statement = connection.createStatement();

            outputArea.append("| MPG | Cylinders | Displacement | Horsepower | Weight | Acceleration | Model Year | Origin | Car Name |\n");

            ResultSet resultSet = statement.executeQuery("select * from cars where car_name like '%" + name + "%' and mpg " + ifEmpty(mpg) + " and cylinders " + ifEmpty(cylinders) + " and displacement " + ifEmpty(displacement) + " and horsepower " + ifEmpty(horsepower) + " and weight " + ifEmpty(weight) + " and acceleration " + ifEmpty(acceleration) + " and model_year " + ifEmpty(year) + " and origin " + ifEmpty(origin) + ";");

            while (resultSet.next())
                outputArea.append("| " + resultSet.getString(1) + " | " + resultSet.getString(2) + " | " + resultSet.getString(3) + " | " + resultSet.getString(4) + " | " + resultSet.getString(5) + " | " + resultSet.getString(6) + " | " + resultSet.getString(7) + " | " + resultSet.getString(8) + " | " + resultSet.getString(9) + " |\n");
            connection.close();
        }
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException, IOException
    {
        ...
        while ((line = br.readLine()) != null)
        {
            ...
            mpg = tmp[0];
            cylinders = tmp[1].replace(".", "");
            displacement = tmp[2];
            horsepower = tmp[3];
            weight = tmp[4].replace(".", "");
            acceleration = tmp[5];
            year = tmp[6].replace(".", "");
            origin = tmp[7].replace(".", "");
            name = tmp[8];
            String sql = "REPLACE INTO cars (mpg, cylinders, displacement, horsepower, weight, acceleration, model_year, origin, car_name) values (" + mpg + ", " + cylinders + ", " + displacement + ", " + horsepower + ", " + weight + ", " + acceleration + ", " + year + ", " + origin + ", '" + name + "')";
            prepared = connection.prepareStatement(sql);
            prepared.executeUpdate();
        }

        CarsFrame myFrame = new CarsFrame();
